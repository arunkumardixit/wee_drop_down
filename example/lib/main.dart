...
class _MyHomePageState extends State<MyHomePage> {
  int _counter = 0;
  List<DDModel> states = [DDModel(value: "-1" ,display: "--State--")];
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            WEEDropDownWidget(itemList: states, selectTitle: "Select State", onChangeEventItem: (WeeDropDownItem we){
...
class DDModel implements WeeDropDownItem{
  ...
  factory DDModel.fromJson(dynamic data){
    return DDModel(value: data["value"],
        display:data["display"]);
  }
  @override
  // TODO: implement barColor
  Color get barColor {
